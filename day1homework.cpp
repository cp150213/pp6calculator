...
double* bubble(double a, double b, double c, double d, double e)
{
...
int main()
{
  ...
  while(true){
    ...
    std::cout << "Enter the operation you would like to perform (+, -, *, /, x, q, l, m, s, b), or type Q to quit:" << std::endl;
    ...
    if(op == 'b')
      {
	std::cout << "Please enter the first element of the array:" << std::endl;
	std::cin >> a;
	// check for bad input
	if(!std::cin)
	  {
	...
	std::cout << "Please enter the second element of the array:" << std::endl;
	std::cin >> b;
	// check for bad input
	if(!std::cin)
	  {
	...
	std::cout << "Please enter the third element of the array:" << std::endl;
	std::cin >> c;
	// check for bad input
	if(!std::cin)
	  {
	...
	std::cout << "Please enter the fourth element of the array:" << std::endl;
	std::cin >> d;
	// check for bad input
	if(!std::cin)
	  {
	...
	std::cout << "Please enter the fifth element of the array:" << std::endl;
	std::cin >> e;
	// check for bad input
	if(!std::cin)
	  {
